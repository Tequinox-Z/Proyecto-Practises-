(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/BehaviorSubject'), require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('@stanvanheumen/ngx-translations')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs/BehaviorSubject', '@angular/core', '@angular/animations', '@angular/common', '@stanvanheumen/ngx-translations'], factory) :
	(factory((global.stanvanheumen = global.stanvanheumen || {}, global.stanvanheumen['ngx-notifications'] = {}),global.Rx,global.ng.core,global.ng.animations,global.ng.common,global.ngxTranslations));
}(this, (function (exports,BehaviorSubject,core,animations,common,ngxTranslations) { 'use strict';
...
var NotificationsService =               (function () {
    function NotificationsService(options) {
        ...
        this.list$ = new BehaviorSubject.BehaviorSubject([]);
        if (!options) {
...
NotificationsService.ctorParameters = function () { return [
    { type: NotificationOptions, decorators: [{ type: core.Optional },] },
]; };
var NgxNotificationsListComponent =               (function () {
...
NgxNotificationsListComponent.decorators = [
    { type: core.Component, args: [{
                ...
                animations: [animations.trigger('listAnimation', [
                        animations.transition('* => *', [
                            animations.query(':enter', animations.style({ opacity: 0 }), { optional: true }),
                            animations.query(':enter', animations.stagger('500ms', [
                                animations.animate('500ms cubic-bezier(0, 0, .2, 1)', animations.keyframes([
                                    animations.style({ opacity: 0, transform: 'translateX(50%)', offset: 0 }),
                                    animations.style({ opacity: 1, transform: 'translateX(0)', offset: 1.0 })
                                ]))
                            ]), { optional: true }),
                            animations.query(':leave', animations.stagger('500ms', [
                                animations.animate('500ms cubic-bezier(0, 0, .2, 1)', animations.keyframes([
                                    animations.style({ height: '*', opacity: 1, transform: 'translateX(0)', offset: 0 }),
                                    animations.style({ height: '*', opacity: 0, transform: 'translateX(-25%)', offset: 0.9 }),
                                    animations.style({ height: 0, opacity: 0, transform: 'translateX(-25%)', offset: 1.0 })
                                ]))
                            ]), { optional: true })
                        ])
                    ])],
...
var NgxNotificationsItemComponent =               (function () {
...
NgxNotificationsModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [common.CommonModule, ngxTranslations.NgxTranslationsModule],
...
exports.NgxNotificationsListComponent = NgxNotificationsListComponent;
exports.ɵa = NgxNotificationsItemComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=stanvanheumen-ngx-notifications.umd.js.map
